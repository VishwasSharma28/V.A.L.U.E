...
exports.ValueScoringService = void 0;
const prisma_1 = require("../lib/prisma");
const USAGE_SCORE_MAP = {
    DAILY: 100,
    WEEKLY: 80,
    MONTHLY: 55,
    RARELY: 25,
...
class ValueScoringService {
     ...
     */
    static async calculateAndStore(userSubscriptionId) {
        const sub = await prisma_1.prisma.userSubscription.findUnique({
    ...
    static async recalculateForUser(userId) {
...
exports.ValueScoringService = ValueScoringService;
//# sourceMappingURL=valueScoring.service.js.map