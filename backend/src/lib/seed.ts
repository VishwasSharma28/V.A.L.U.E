...
async function seedSubscriptionTaxonomy() {
  ...
  const providers = [
    // Mobile
    { subcategoryName: 'Mobile prepaid', name: 'Airtel', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['telecom', 'mobile'] },
    { subcategoryName: 'Mobile prepaid', name: 'Jio', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['telecom', 'mobile'] },
    { subcategoryName: 'Mobile prepaid', name: 'Vi', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['telecom', 'mobile'] },

    // Broadband
    { subcategoryName: 'Fiber broadband', name: 'Airtel', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['internet', 'broadband'] },
    { subcategoryName: 'Fiber broadband', name: 'Jio', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['internet', 'broadband'] },
    { subcategoryName: 'Fiber broadband', name: 'ACT Fibernet', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['internet', 'broadband'] },

    // OTT Global
    { subcategoryName: 'Premium streaming', name: 'Netflix', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['streaming', 'entertainment'] },
    { subcategoryName: 'Premium streaming', name: 'Amazon Prime Video', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['streaming', 'entertainment'] },
    { subcategoryName: 'Premium streaming', name: 'Disney+', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['streaming', 'entertainment'] },

    // OTT India
    { subcategoryName: 'Regional OTT', name: 'JioHotstar', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['streaming', 'indian', 'sports'] },
    { subcategoryName: 'Regional OTT', name: 'Zee5', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['streaming', 'indian'] },
    { subcategoryName: 'Regional OTT', name: 'SonyLiv', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['streaming', 'indian'] },

    // AI
    { subcategoryName: 'AI chatbots', name: 'ChatGPT', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['ai', 'productivity'] },
    { subcategoryName: 'AI chatbots', name: 'Claude', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['ai', 'productivity'] },

    // Cloud
    { subcategoryName: 'IaaS', name: 'AWS', region: 'GLOBAL' as const, businessType: 'BOTH' as const, tags: ['cloud', 'infrastructure'] },
    { subcategoryName: 'IaaS', name: 'Google Cloud', region: 'GLOBAL' as const, businessType: 'BOTH' as const, tags: ['cloud', 'infrastructure'] },
    { subcategoryName: 'Serverless', name: 'Vercel', region: 'GLOBAL' as const, businessType: 'BOTH' as const, tags: ['cloud', 'serverless'] },

    // Productivity
    { subcategoryName: 'Project management', name: 'Notion', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['productivity', 'notes'] },
    { subcategoryName: 'Project management', name: 'Asana', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['productivity', 'tasks'] },
    { subcategoryName: 'Communication', name: 'Slack', region: 'GLOBAL' as const, businessType: 'BOTH' as const, tags: ['communication', 'team'] },

    // Gaming
    { subcategoryName: 'Console passes', name: 'Xbox Game Pass', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['gaming', 'microsoft'] },
    { subcategoryName: 'Console passes', name: 'PlayStation Plus', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['gaming', 'sony'] },
    { subcategoryName: 'Cloud gaming', name: 'GeForce Now', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['gaming', 'cloud'] },

    // Health
    { subcategoryName: 'Gym memberships', name: 'Cult.fit', region: 'INDIA' as const, businessType: 'B2C' as const, tags: ['fitness', 'gym'] },
    { subcategoryName: 'Digital fitness', name: 'Peloton', region: 'GLOBAL' as const, businessType: 'B2C' as const, tags: ['fitness', 'digital'] },
  ];
  ...
  const plans = [
    // Airtel Prepaid
    { planTypeName: 'Prepaid', name: '₹299 Prepaid Pack', monthlyCost: 299, billingCycle: 'MONTHLY' as const, features: ['1.5GB/day', 'Unlimited calls', '100 SMS/day'], tags: ['prepaid', 'data', 'calls'] },
    { planTypeName: 'Prepaid', name: '₹889 Family Pack', monthlyCost: 889, billingCycle: 'MONTHLY' as const, features: ['3GB/day', 'Unlimited calls', 'Family sharing', 'Hotstar included'], tags: ['prepaid', 'family', 'ott'] },

    // Netflix
    { planTypeName: 'Basic', name: 'Netflix Basic', monthlyCost: 199, billingCycle: 'MONTHLY' as const, features: ['SD streaming', '1 device'], tags: ['streaming', 'basic'] },
    { planTypeName: 'Standard', name: 'Netflix Standard', monthlyCost: 499, billingCycle: 'MONTHLY' as const, features: ['HD streaming', '2 devices'], tags: ['streaming', 'hd'] },
    { planTypeName: 'Premium', name: 'Netflix Premium', monthlyCost: 649, billingCycle: 'MONTHLY' as const, features: ['4K streaming', '4 devices'], tags: ['streaming', '4k'] },

    // ChatGPT
    { planTypeName: 'Plus', name: 'ChatGPT Plus', monthlyCost: 1650, billingCycle: 'MONTHLY' as const, features: ['GPT-4 access', 'Priority support'], tags: ['ai', 'gpt4'] },

    // AWS
    { planTypeName: 'EC2', name: 'AWS EC2 t3.micro', monthlyCost: 850, billingCycle: 'MONTHLY' as const, features: ['1 vCPU', '1GB RAM', 'Linux'], tags: ['cloud', 'compute'] },

    // Notion
    { planTypeName: 'Personal', name: 'Notion Personal', monthlyCost: 0, billingCycle: 'MONTHLY' as const, features: ['Unlimited blocks', '5GB file uploads'], tags: ['productivity', 'free'] },
    { planTypeName: 'Team', name: 'Notion Team', monthlyCost: 320, billingCycle: 'MONTHLY' as const, features: ['Unlimited team members', '10GB storage'], tags: ['productivity', 'team'] },

    // Xbox
    { planTypeName: 'Ultimate', name: 'Xbox Game Pass Ultimate', monthlyCost: 699, billingCycle: 'MONTHLY' as const, features: ['100+ games', 'EA Play included', 'Cloud gaming'], tags: ['gaming', 'ultimate'] },
  ];
...
async function seedUserSubscriptions(userId: string) {
  ...
  for (let i = 0; i < plans.length; i++) {
    ...
    const sub = await prisma.userSubscription.create({
      data: {
        userId,
        planId: plan.id,
        usageFrequency: ['DAILY', 'WEEKLY', 'MONTHLY', 'RARELY'][i % 4] as any,
...
async function seedValueScores(userId: string) {
  const userSubs = await prisma.userSubscription.findMany({
    where: { userId },
    include: { plan: true }
  });

  const scoreMap: Record<string, { eff: number; waste: number; cpu: number; usage: number }> = {
...
async function seedUsageLogs(userId: string) {
  const userSubs = await prisma.userSubscription.findMany({
    where: { userId },
    include: { plan: true }
  });
...
async function seedRecommendations(userId: string) {
  const userSubs = await prisma.userSubscription.findMany({
    where: { userId },
    include: { plan: true }
  });
  ...
  const recs = [
    { userSubscriptionId: awsSub?.id, type: 'CANCEL' as const, title: 'AWS EC2 instance idle 78% of time', description: 'Your AWS instance shows very low utilisation. Consider switching to on-demand or serverless.', savingAmount: 2200, impactScore: 88 },
    { userSubscriptionId: netflixSub?.id, type: 'DOWNGRADE' as const, title: 'Switch Netflix Premium to Standard', description: 'You primarily watch on mobile. The Standard plan saves ₹150/mo with no quality loss.', savingAmount: 150, impactScore: 92 },
    { type: 'OVERLAP_DETECTED' as const, title: 'Multiple streaming services detected', description: 'Netflix + Prime Video overlap. Consider consolidating to save costs.', savingAmount: 438, impactScore: 79 },
    { type: 'COST_OPTIMIZATION' as const, title: 'Notion annual plan saves 20%', description: 'Switch to annual billing and save ₹768/year on your Notion subscription.', savingAmount: 64, impactScore: 70 },
    { type: 'COMPLEMENTARY' as const, title: 'Add Spotify for better value', description: 'Your Netflix subscription could be complemented with Spotify for ₹119/mo.', savingAmount: 0, impactScore: 65 },
  ];
...
async function seedLedgerRecords(userId: string) {
  const userSubs = await prisma.userSubscription.findMany({
    where: { userId },
    take: 5,
    include: { plan: true }
...
async function seedAnalyticsSnapshot(userId: string) {
